...
Error (01): @entityID values must start with “https://”
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (starts-with(@entityID,'https://'))</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
