...
Warning (03): Each IDPSSODescriptor should contain NameIDFormat with one or more values
       XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (md:NameIDFormat[text() != ''])</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template><axsl:template match="//md:SPSSODescriptor" priority="1000" mode="M10">

		<!--ASSERT -->
<axsl:choose><axsl:when test="md:NameIDFormat[text() != '']"/><axsl:otherwise><axsl:message>
Warning (03): Each SPSSODescriptor should contain NameIDFormat with one or more values
       XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (md:NameIDFormat[text() != ''])</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
