...
Warning (05): EntityDescriptor should contain an Organization
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (md:Organization)</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
