...
Warning (06): EntityDescriptor should contain ContactPerson with a contactType of "support" and at least one EmailAddress
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (md:ContactPerson[normalize-space(@contactType)='support'][md:EmailAddress])</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
