...
Warning (10): IDPSSODescriptor contains &lt;saml2:Attribute&gt; elements; but implementations may not understand this.
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (descendant::saml:Attribute)</axsl:message></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
