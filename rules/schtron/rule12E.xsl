...
Error (12): IDPSSODescriptor must contain alg:DigestMethod
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (descendant::alg:DigestMethod)</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template><axsl:template match="//md:SPSSODescriptor" priority="1000" mode="M10">

		<!--ASSERT -->
<axsl:choose><axsl:when test="descendant::alg:DigestMethod"/><axsl:otherwise><axsl:message>
Error (12): SPSSODescriptor must contain alg:DigestMethod
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (descendant::alg:DigestMethod)</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
