...
Warning (15): IDPSSODescriptor should contain SingleLogoutService
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (md:SingleLogoutService)</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template><axsl:template match="//md:SPSSODescriptor" priority="1000" mode="M10">

		<!--ASSERT -->
<axsl:choose><axsl:when test="md:SingleLogoutService"/><axsl:otherwise><axsl:message>
Warning (15): SPSSODescriptor should contain SingleLogoutService
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (md:SingleLogoutService)</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
