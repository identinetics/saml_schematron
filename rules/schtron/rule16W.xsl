...
Warning (16): AttributeConsumingService is deprecated. Use EntityCategories instead.
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (md:AttributeConsumingService)</axsl:message></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
