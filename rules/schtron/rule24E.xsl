...
<!--SCHEMA METADATA-->
<axsl:template match="/"><axsl:apply-templates select="/" mode="M0"/><axsl:apply-templates select="/" mode="M0"/></axsl:template>

<!--SCHEMATRON PATTERNS-->
<axsl:template match="/" name="bryansgeneratedtemplate"><axsl:apply-templates mode="M10"/></axsl:template><axsl:template match="text()" mode="M10"/><axsl:template match="md:EntityDescriptor" priority="1001" mode="M10">

		<!--REPORT -->
<axsl:if test="@entityID"><axsl:message>
Info: Validating entityID <axsl:text/><axsl:value-of select="@entityID"/><axsl:text/>
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (@entityID)</axsl:message></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template><axsl:template match="alg:SigningMethod" priority="1000" mode="M10">
...
Error (24): Each alg:SigningMethod may only contain following @Algorithm values: 
    ...
    http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha512    
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (@Algorithm='http://www.w3.org/2001/04/xmldsig-more#rsa-sha256' or @Algorithm='http://www.w3.org/2000/09/xmldsig#rsa-sha1' or @Algorithm='http://www.w3.org/2001/04/xmldsig-more#rsa-sha384' or @Algorithm='http://www.w3.org/2001/04/xmldsig-more#rsa-sha512' or @Algorithm='http://www.w3.org/2001/04/xmldsig-more#rsa-ripemd160' or @Algorithm='http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha256' or @Algorithm='http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha384' or @Algorithm='http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha512')</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
