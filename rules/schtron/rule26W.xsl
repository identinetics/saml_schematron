...
Warning (26): SigningMethod element should not contain @Algorithm value http://www.w3.org/2000/09/xmldsig#rsa-sha1
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (@Algorithm !='http://www.w3.org/2000/09/xmldsig#rsa-sha1')</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
