...
Error (29): alg:SigningMethod must have an attribute MaxKeySize
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (@MaxKeySize)</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
