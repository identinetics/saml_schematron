...
Warning (31): @entityID length should not exceed 80 characters”
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (string-length(@entityID) &lt; 81)</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
