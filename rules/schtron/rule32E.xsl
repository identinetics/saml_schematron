...
Error (32): IDPSSODescriptor  must contain a mdui:UIInfo element
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (md:Extensions/mdui:UIInfo)</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
