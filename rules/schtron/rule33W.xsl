...
Warning (33): IDPSSODescriptor should contain alg:DigestMethod
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (md:Extensions/alg:DigestMethod)</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template><axsl:template match="//md:SPSSODescriptor" priority="1000" mode="M10">

		<!--ASSERT -->
<axsl:choose><axsl:when test="md:Extensions/alg:DigestMethod"/><axsl:otherwise><axsl:message>
Warning (33): SPSSODescriptor should contain alg:DigestMethod
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (md:Extensions/alg:DigestMethod)</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
