...
Warning (34): IDPSSODescriptor should contain alg:SigningMethod
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (md:Extensions/alg:SigningMethod)</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template><axsl:template match="//md:SPSSODescriptor" priority="1000" mode="M10">

		<!--ASSERT -->
<axsl:choose><axsl:when test="md:Extensions/alg:SigningMethod"/><axsl:otherwise><axsl:message>
Warning (34): SPSSODescriptor should contain alg:SigningMethod
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (md:Extensions/alg:SigningMethod)</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
