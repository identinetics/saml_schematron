...
Error (35): protocolSupportEnumeration may contain only "urn:oasis:names:tc:SAML:2.0:protocol"
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (normalize-space(@protocolSupportEnumeration)='urn:oasis:names:tc:SAML:2.0:protocol')</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
