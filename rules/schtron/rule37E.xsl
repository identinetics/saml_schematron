...
<!--SCHEMATRON PATTERNS-->
<axsl:template match="/" name="bryansgeneratedtemplate"><axsl:apply-templates mode="M10"/></axsl:template><axsl:template match="text()" mode="M10"/><axsl:template match="md:EntityDescriptor" priority="1000" mode="M10">
...
Warning (37): EntityDescriptor should contain EntityAttributes with an AttributeValue of http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken
     XPATH: <axsl:call-template name="xpathgetter"/> validation rule: (descendant::mdattr:EntityAttributes[saml:Attribute[normalize-space(saml:AttributeValue)='http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken']])</axsl:message></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template></axsl:stylesheet>
