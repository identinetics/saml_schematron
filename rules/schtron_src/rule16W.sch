...
<iso:pattern id="Rule16_ACS_depr" xmlns:iso="http://purl.oclc.org/dsdl/schematron" >
  <iso:rule context="//md:EntityDescriptor">
    <iso:report test="md:SPSSODescriptor/md:AttributeConsumingService and //saml:AttributeValue[starts-with(normalize-space(text()), 'http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken')
