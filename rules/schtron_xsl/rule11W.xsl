...
<axsl:template match="//md:SPSSODescriptor" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="md:AssertionConsumerService[normalize-space(@Binding)='urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST']"/><axsl:otherwise><axsl:message>"rule11W": { "Severity": "Warning",
         "Message": "SPSSODescriptor should contain an AssertionConsumerService with Binding=\"urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST\"",
             ...
             "Rule": "md:AssertionConsumerService[normalize-space(@Binding)='urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST']"}
