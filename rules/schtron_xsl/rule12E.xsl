...
<axsl:template match="//md:IDPSSODescriptor|//md:SPSSODescriptor" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="descendant::alg:DigestMethod"/><axsl:otherwise><axsl:message>"rule12E": { "Severity": "Error",
         "Message": "IDPSSODescriptor/SPSSODescriptor must contain alg:DigestMethod",
             "Context": "<axsl:call-template name="xpathgetter"/>",
             "Rule": "descendant::alg:DigestMethod"}
