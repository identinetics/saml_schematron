...
<axsl:template match="//md:IDPSSODescriptor|//md:SPSSODescriptor" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="descendant::alg:SigningMethod"/><axsl:otherwise><axsl:message>"rule13E": { "Severity": "Error",
         "Message": "IDPSSODescriptor/SPSSODescriptor must contain SigningMethod",
             "Context": "<axsl:call-template name="xpathgetter"/>",
             "Rule": "descendant::alg:SigningMethod"}
