...
<axsl:template match="//md:IDPSSODescriptor" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="md:Extensions/mdui:DiscoHints"/><axsl:otherwise><axsl:message>"rule14W": { "Severity": "Warning",
         "Message": "IDPSSODescriptor should contain discovery hints",
             "Context": "<axsl:call-template name="xpathgetter"/>",
             "Rule": "md:Extensions/mdui:DiscoHints"}
