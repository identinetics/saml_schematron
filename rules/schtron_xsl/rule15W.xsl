...
<axsl:template match="//md:IDPSSODescriptor|//md:SPSSODescriptor" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="md:SingleLogoutService"/><axsl:otherwise><axsl:message>"rule15W": { "Severity": "Warning",
         "Message": "IDPSSODescriptor/SPSSODescriptor should contain SingleLogoutService",
             "Context": "<axsl:call-template name="xpathgetter"/>",
             "Rule": "md:SingleLogoutService"}
