...
<axsl:template match="//md:EntityDescriptor" priority="1000" mode="M0">
		...
		<!--REPORT -->
<axsl:if test="md:SPSSODescriptor/md:AttributeConsumingService and //saml:AttributeValue[normalize-space(text()) = 'http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken'                                  or normalize-space(text()) = 'http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken-charge']"><axsl:message>"rule16W": { "Severity": "Warning",
         "Message": "AttributeConsumingService is deprecated if EntityCategory has an fixed set of RequestedAttributes.",
             ...
             "Rule": "md:SPSSODescriptor/md:AttributeConsumingService and //saml:AttributeValue[normalize-space(text()) = 'http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken' or normalize-space(text()) = 'http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken-charge']"}
