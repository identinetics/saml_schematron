...
<!--PATTERN Rule19_EAval-->


	<!--RULE -->
<axsl:template match="//md:EntityDescriptor/md:Extensions/mdattr:EntityAttributes/saml:Attribute" priority="1000" mode="M0">

		<!--ASSERT -->
<axsl:choose><axsl:when test="saml:AttributeValue[normalize-space(text()) = 'http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken'                                  or normalize-space(text()) = 'http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken-charge']"/><axsl:otherwise><axsl:message>"rule19W": { "Severity": "Warning",
         "Message": "EntityCategories should be restricted to these values:\n  http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken,\n  http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken-charge",
             ...
             "Rule": "saml:AttributeValue[normalize-space(text()) = 'http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken' or normalize-space(text()) = 'http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken-charge']"}
