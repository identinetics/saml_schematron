...
<axsl:template match="//md:SPSSODescriptor" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="md:Extensions/init:RequestInitiator"/><axsl:otherwise><axsl:message>"rule20W": { "Severity": "Warning",
         "Message": "SPSSODescriptor should include init:RequestInitiator",
             "Context": "<axsl:call-template name="xpathgetter"/>",
             "Rule": "md:Extensions/init:RequestInitiator"}
