...
<axsl:template match="//md:SPSSODescriptor" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="md:Extensions/mdui:UIInfo"/><axsl:otherwise><axsl:message>"rule21W": { "Severity": "Warning",
         "Message": "SPSSODescriptor should include a mdui:UIInfo element",
             "Context": "<axsl:call-template name="xpathgetter"/>",
             "Rule": "md:Extensions/mdui:UIInfo"}
