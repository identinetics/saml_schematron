...
<!--PATTERN Rule23_ALGDigest-->


	<!--RULE -->
<axsl:template match="alg:DigestMethod" priority="1000" mode="M0">

		<!--ASSERT -->
<axsl:choose><axsl:when test="normalize-space(@Algorithm)='http://www.w3.org/2001/04/xmlenc#sha256'                    or normalize-space(@alg:Algorithm)='http://www.w3.org/2001/04/xmlenc#sha256'                    or normalize-space(@Algorithm)='http://www.w3.org/2000/09/xmldsig#sha1'                    or normalize-space(@alg:Algorithm)='http://www.w3.org/2000/09/xmldsig#sha1'                    or normalize-space(@Algorithm)='http://www.w3.org/2001/04/xmlenc#sha512'                    or normalize-space(@alg:Algorithm)='http://www.w3.org/2001/04/xmlenc#sha512'                    or normalize-space(@Algorithm)='http://www.w3.org/2001/04/xmlenc#ripemd160'                    or normalize-space(@alg:Algorithm)='http://www.w3.org/2001/04/xmlenc#ripemd160' "/><axsl:otherwise><axsl:message>"rule23E": { "Severity": "Error",
