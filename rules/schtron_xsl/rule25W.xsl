...
<axsl:template match="alg:DigestMethod" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="@Algorithm !='http://www.w3.org/2000/09/xmldsig#sha1'"/><axsl:otherwise><axsl:message>"rule25W": { "Severity": "Warning",
         "Message": "DigestMethod element should not contain @Algorithm value http://www.w3.org/2000/09/xmldsig#sha1",
             ...
             "Rule": "@Algorithm !='http://www.w3.org/2000/09/xmldsig#sha1'"}
