...
<axsl:template match="alg:SigningMethod" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="@Algorithm !='http://www.w3.org/2000/09/xmldsig#rsa-sha1'"/><axsl:otherwise><axsl:message>"rule26W": { "Severity": "Warning",
         "Message": "SigningMethod element should not contain @Algorithm value http://www.w3.org/2000/09/xmldsig#rsa-sha1",
             ...
             "Rule": "@Algorithm !='http://www.w3.org/2000/09/xmldsig#rsa-sha1'"}
