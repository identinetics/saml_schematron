...
<axsl:template match="alg:SigningMethod" priority="1000" mode="M0">
		...
		<!--REPORT -->
<axsl:if test="starts-with(@Algorithm, 'http://www.w3.org/2001/04/xmldsig-more#rsa') and @MinKeySize &lt; 2048"><axsl:message>"rule27E": { "Severity": "Error",
         "Message": "MinKeySize must be greater or equal to 2048 if Algorithm starts with http://www.w3.org/2001/04/xmldsig-more#rsa",
             "Context": "<axsl:call-template name="xpathgetter"/>",
             "Rule": "starts-with(@Algorithm, 'http://www.w3.org/2001/04/xmldsig-more#rsa') and @MinKeySize &lt; 2048"}
