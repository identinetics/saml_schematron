...
<axsl:template match="alg:SigningMethod" priority="1000" mode="M0">
		...
		<!--REPORT -->
<axsl:if test="starts-with(@Algorithm, 'http://www.w3.org/2001/04/xmldsig-more#ecdsa') and number(@MinKeySize) &lt; 256"><axsl:message>"rule28E": { "Severity": "Error",
         "Message": "MinKeySize must be greater or equal to 256 if Algorithm starts with http://www.w3.org/2001/04/xmldsig-more#ecdsa",
             ...
             "Rule": "starts-with(@Algorithm, 'http://www.w3.org/2001/04/xmldsig-more#ecdsa') and number(@MinKeySize) &lt; 256"}
