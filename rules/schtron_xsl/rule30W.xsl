...
<!--PATTERN Rule30_Artifact-->


	<!--RULE -->
<axsl:template match="md:AssertionConsumerService" priority="1000" mode="M0">

		<!--REPORT -->
<axsl:if test="normalize-space(@Binding)='urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Artifact'"><axsl:message>"rule30W": { "Severity": "Warning",
         "Message": "AssertionConsumerService Binding=\"urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Artifact is deprecated\"",
             ...
             "Rule": "normalize-space(@Binding)='urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Artifact'"}
