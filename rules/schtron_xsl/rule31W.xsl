...
<axsl:template match="md:EntityDescriptor" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="string-length(@entityID) &lt; 81"/><axsl:otherwise><axsl:message>"rule31W": { "Severity": "Warning",
         "Message": "@entityID length should not exceed 80 characters",
             "Context": "<axsl:call-template name="xpathgetter"/>",
             "Rule": "string-length(@entityID) &lt; 81"}
