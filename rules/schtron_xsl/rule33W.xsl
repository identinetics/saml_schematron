...
<axsl:template match="//md:IDPSSODescriptor|//md:SPSSODescriptor" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="md:Extensions/alg:DigestMethod"/><axsl:otherwise><axsl:message>"rule33W": { "Severity": "Warning",
         "Message": "IDPSSODescriptor/SPSSODescriptor should contain alg:DigestMethod",
             "Context": "<axsl:call-template name="xpathgetter"/>",
             "Rule": "md:Extensions/alg:DigestMethod"}
