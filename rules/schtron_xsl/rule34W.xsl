...
<axsl:template match="//md:IDPSSODescriptor|//md:SPSSODescriptor" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="md:Extensions/alg:SigningMethod"/><axsl:otherwise><axsl:message>"rule34W": { "Severity": "Warning",
         "Message": "IDPSSODescriptor/SPSSODescriptor should contain alg:SigningMethod",
             "Context": "<axsl:call-template name="xpathgetter"/>",
             "Rule": "md:Extensions/alg:SigningMethod"}
