...
<axsl:template match="//md:IDPSSODescriptor" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="normalize-space(@protocolSupportEnumeration)='urn:oasis:names:tc:SAML:2.0:protocol'"/><axsl:otherwise><axsl:message>"rule35W": { "Severity": "Warning",
         "Message": "protocolSupportEnumeration should contain only \"urn:oasis:names:tc:SAML:2.0:protocol\" (-&gt; remove support for legacy protocols)",
             ...
             "Rule": "normalize-space(@protocolSupportEnumeration)='urn:oasis:names:tc:SAML:2.0:protocol'"}
