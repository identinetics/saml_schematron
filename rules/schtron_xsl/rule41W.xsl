...
<axsl:template match="//md:EntityDescriptor/md:Extensions/mdattr:EntityAttributes/saml:Attribute" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="saml:AttributeValue[normalize-space(text()) = 'http://wirtschaftsportalverbund.at/ns/ec/attributebundle-wkis']"/><axsl:otherwise><axsl:message>"rule41W": { "Severity": "Warning",
         "Message": "EntityCategories understood in this federation are:\n    http://wirtschaftsportalverbund.at/ns/ec/attributebundle-wkis",
             ...
             "Rule": "saml:AttributeValue[normalize-space(text()) = 'http://wirtschaftsportalverbund.at/ns/ec/attributebundle-wkis']"}
