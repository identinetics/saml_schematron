...
<axsl:template match="md:NameIDFormat" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="normalize-space(text()) = 'urn:oasis:names:tc:SAML:2.0:nameid-format:persistent'                 or normalize-space(text()) = 'urn:oasis:names:tc:SAML:2.0:nameid-format:transient'                or normalize-space(text()) = '' "/><axsl:otherwise><axsl:message>"rule42W": { "Severity": "Warning",
