...
<axsl:template match="//md:EntityDescriptor" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="md:Extensions/mdattr:EntityAttributes/saml:Attribute/saml:AttributeValue[normalize-space(text()) = 'http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken'] or                 md:Extensions/mdattr:EntityAttributes/saml:Attribute/saml:AttributeValue[normalize-space(text()) = 'http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken-charge'] or                 md:IDPSSODescriptor"/><axsl:otherwise><axsl:message>"rule44W": { "Severity": "Warning",
         "Message": "EntityDescriptor should contain an EntityCategory of this list:\n  http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken,\n  http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken-charge",
             ...
             "Rule": "md:Extensions/mdattr:EntityAttributes/saml:Attribute/saml:AttributeValue[normalize-space(text()) = 'http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken'] or md:Extensions/mdattr:EntityAttributes/saml:Attribute/saml:AttributeValue[normalize-space(text()) = 'http://www.ref.gv.at/ns/names/agiz/pvp/egovtoken-charge'] or md:IDPSSODescriptor"}
