...
<axsl:template match="//md:EntityDescriptor" priority="1000" mode="M0">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="md:Extensions/mdattr:EntityAttributes/saml:Attribute/saml:AttributeValue[normalize-space(text()) = 'http://wirtschaftsportalverbund.at/namespaces/ecStandardAttributes/20160322'] or                 md:IDPSSODescriptor"/><axsl:otherwise><axsl:message>"rule44W": { "Severity": "Warning",
         "Message": "EntityDescriptor should contain the EntityCategory http://wirtschaftsportalverbund.at/namespaces/ecStandardAttributes/20160322",
             "Context": "<axsl:call-template name="xpathgetter"/>",
             "Rule": "md:Extensions/mdattr:EntityAttributes/saml:Attribute/saml:AttributeValue[normalize-space(text()) = 'http://wirtschaftsportalverbund.at/namespaces/ecStandardAttributes/20160322'] or md:IDPSSODescriptor"}
