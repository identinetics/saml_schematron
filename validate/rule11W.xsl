...
<!--SCHEMATRON PATTERNS-->
<axsl:template match="/" name="bryansgeneratedtemplate"><axsl:apply-templates mode="M10"/></axsl:template><axsl:template match="text()" mode="M10"/><axsl:template match="//md:SPSSODescriptor" priority="1000" mode="M10">
